...
|-------------|-----------------|
| Programación por bloques en Scratch (Parte 1)... | <img src="unidad1/perritoScratch.png" width="600"/> |
| Programación por bloques en Scratch (Parte 2)... | <img src="unidad1/perritoScratch_cambio_deFondo.png" width="600"/> |
| Algoritmo en pseudocódigo – Cálculo de la masa del aire... | [`algoritmo_masa.psc`](unidad1/masa.psc) |
| Prueba de escritorio Pseint | <img src="unidad1/ejecucion_Pseint.png" width="600"/> |
| Algoritmo en C – Cálculo de la masa del aire... | [`algoritmo_masa.c`](unidad1/algoritmo_masa.c) |
| Prueba de escritorio de C | <img src="unidad1/ejecucion_Copilacion_EnC.png" width="600"/> |
| Prueba de escritorio de manual | <img src="unidad1/pruebaDeEscirtorioManual.png" width="600"/> |
| Diagrama de flujo del algoritmo | <img src="unidad1/diagrama_masa.png" width="600"/> |
