...
Las **estructuras condicionales** permiten que un programa tome decisiones basadas en una condición lógica. De esta manera, el flujo del programa puede cambiar dependiendo si dicha condición se cumple (**verdadero**) o no (**falso**).

Las principales estructuras condicionales tratadas fueron:
...
### ✔️ *Condiciones anidadas*
Utilizadas cuando se debe evaluar más de una condición de manera jerárquica.

### ✔️ *Condiciones múltiples según*
Estructura ideal para evaluar varias opciones posibles.

Estas herramientas permiten que el programa seleccione la acción adecuada según la situación, volviéndose fundamental para la toma de decisiones.
